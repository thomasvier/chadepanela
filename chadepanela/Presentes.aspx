...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="margin-left: 330px; margin-top: 20px">
        <div style="width:900px">
            <p>Meninas, os itens com o <img src="Imagens/gift.png" class="btnIcon"/> estão esperando para vocês marcarem para me dar. E os que estão no <img src="Imagens/sold.png" class="btnIcon"/> alguém já escolheu.</p>                                    
        </div>
